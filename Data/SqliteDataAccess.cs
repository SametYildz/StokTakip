...
CREATE TABLE IF NOT EXISTS Fatura (
    ...
    KdvYuzdesi REAL
            ...
            {
                throw new InvalidOperationException("Native SQLite saðlayýcýsý yüklenemedi. System.Data.SQLite paketini ve platform hedefinizi (x86/x64) kontrol edin. Orijinal hata: " + ex.Message, ex);
            }
        }
